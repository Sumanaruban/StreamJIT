...
function writeRun(){
	...
	echo "srun -l ../bin/java/jdk1.8.0_31/bin/java -Xmx120G -jar $1.jar $3" >> $runfile
}
...
function writeSN(){
	...
	echo "#SBATCH --exclusive" >> $runfile
	echo "cd /data/scratch/sumanan/"$1 >> $runfile
	echo "srun --exclusive  --nodes=$2 ../bin/java/jdk1.8.0_31/bin/java -Xmx120G -jar StreamNode.jar 128.30.116." >> $runfile
}
